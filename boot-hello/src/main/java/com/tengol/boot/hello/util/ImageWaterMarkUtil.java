...
public class ImageWaterMarkUtil {
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath="D:\\img_test_1.jpg"; //源图片地址
        String tarImgPath="D:\\img_test_222222.jpg"; //待存储的地址
        String waterMarkContent="图片来源：http://blog.csdn.net/zjq_1314520";  //水印内容
        Color color=new Color(255,255,255,128);                               //水印图片色彩以及透明度
        new ImageWaterMarkUtil().addWaterMark(srcImgPath, tarImgPath, waterMarkContent, Color.RED, font);
